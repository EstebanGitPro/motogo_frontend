...
class _$InjectorApp extends InjectorApp {
  ...
  void _configureAuthFactories() {
    final KiwiContainer container = KiwiContainer();
    container
      ..registerFactory<RegisterPersonRepository>(
        (c) =>
      ...
      ..registerFactory<EmailRecoveryVerificationRepository>(
        (c) => EmailRecoveryVerificationRepositoryImpl(
          c.resolve<EmailRecoveryVerificationDataSource>(),
        ),
      )
      ..registerFactory(
        (c) => VerifyRecoveryEmailUseCase(
      ...
      ..registerFactory<DeleteBranchRepository>(
        (c) => DeleteBranchRepositoryImpl(c.resolve<DeleteBranchDataSource>()),
      )
      ..registerFactory(
      ...
      ..registerFactory<DeletePersonRepository>(
        (c) => DeletePersonRepositoryImpl(c.resolve<DeletePersonDataSource>()),
      )
      ..registerFactory(
        (c) => DeletePersonUseCase(c.resolve<DeletePersonRepository>()),
      )
      ..registerFactory<FranchiseRepository>(
        (c) =>

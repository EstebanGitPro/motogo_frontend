...
class CodeValidationDataSource {
  ...
  Future<Either<ErrorModel, bool>> validateCode(String code) async {
    try {
      ...
      final isValid = decoded['status'] as String?;

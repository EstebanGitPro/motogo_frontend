...
// in motogo_frontend/test/features/service_ratings/data/repositories/service_rating_repository_impl_test.dart.
...
/// A class which mocks [ServiceRatingDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockServiceRatingDataSource extends _i1.Mock
    implements _i2.ServiceRatingDataSource {
  MockServiceRatingDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<_i4.Either<_i5.ErrorModel, String>> rateServiceItem(
    String? completedServiceId,
    String? itemId,
    _i6.RateServiceRequest? request,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#rateServiceItem, [
              completedServiceId,
              itemId,
              request,
            ]),
